...
/**
 * This interface defines the methods that must be provided by any curve
 * interpolator.
 * 
 * @author Peter Werno
 */
public interface CurveInterpolator {
    ...
    public TermRate interpolate(Date forwardDate) throws CurveInterpolationException, DaycountException;
}
