...
/**
 * This class impements the daycount convention "30E+/360".
 * 
 * Convention:
 * If day(startDate) = 31, then day(startDate) is set to 30
 * If day(endDate) = 31, then day(endDate) is set to 1, month(endDate)++
 * 
 * 
 ...
 * @author peter
 */
public class D30EP_360 extends D30E_360_ISMA {
