...
/**
 * This class implements the trigonometrical function arcsin
 * (arc sinus)
 * 
 * @author Peter Werno
 */
public class Arcsin extends Node {
    /**
     * Creates a new instance of Arcsin
     */
    public Arcsin() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arcsin with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arcsin(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arcsin();
    }
    ...
    @Override
    public Node copy() {
        return new Arcsin(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arcsin(");
