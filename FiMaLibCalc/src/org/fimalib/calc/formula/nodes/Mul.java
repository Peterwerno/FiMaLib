...
/**
 * This class implements a calculation/formula node which just multiplies the
 * two sub-nodes
 * 
 * @author Peter Werno
 */
public class Mul extends Node {
    ...
    /**
     * Creates a new instance of Mul with given subnodes
     * 
