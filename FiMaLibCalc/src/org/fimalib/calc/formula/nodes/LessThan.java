 ...
 * 'true' if the first subnode is less than the second subnode, 
 * otherwise it returns 'false'.
 * 
 * For complex numbers, LessThan compares the ABSOLUTE value of the numbers,
...
public class LessThan extends Node {
    ...
    /**
     * Creates a new instance of LessThan with both subnodes given
     * 
    ...
    @Override
    public Node copy() {
        return new LessThan(this.subNodes[0].copy(), this.subNodes[1].copy());
    }
