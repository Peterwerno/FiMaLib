...
/**
 * This class implements the trigonometrical function arccsch
 * (arc cosecant hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arccsch extends Node {
    /**
     * Creates a new instance of Arccsch
     */
    public Arccsch() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccsch with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccsch(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccsch();
    }
    ...
    @Override
    public Node copy() {
        return new Arccsch(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccsch(");
