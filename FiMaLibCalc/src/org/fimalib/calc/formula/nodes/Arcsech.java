...
/**
 * This class implements the trigonometrical function arcsech
 * (arc sekant hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arcsech extends Node {
    /**
     * Creates a new instance of Arcsech
     */
    public Arcsech() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arcsech with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arcsech(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arcsech();
    }
    ...
    @Override
    public Node copy() {
        return new Arcsech(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arcsech(");
