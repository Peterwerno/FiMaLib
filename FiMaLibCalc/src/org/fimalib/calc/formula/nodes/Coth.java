...
/**
 * This class implements the trigonometrical function coth
 * (cotangent hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Coth extends Node {
    /**
     * Creates a new instance of Coth
     */
    public Coth() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Coth with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Coth(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).coth();
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("coth(");
