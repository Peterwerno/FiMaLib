...
/**
 * This class implements the signum function of a number
 * 
 * @author Peter Werno
 */
public class Sgn extends Node {
    /**
     * Creates a new instance of Sgn
     */
    public Sgn() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Sgn with a given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Sgn(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sgn();
    }
    ...
    @Override
    public Node copy() {
        return new Sgn(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sgn(");
