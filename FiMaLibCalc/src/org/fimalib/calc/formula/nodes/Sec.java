...
/**
 * This class implements the trigonometrical function sec
 * (secant)
 * 
 * @author Peter Werno
 */
public class Sec extends Node {
    /**
     * Creates a new instance of Sec
     */
    public Sec() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Sec with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Sec(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sec();
    }
    ...
    public Node derive(String parameterName) throws FormulaException {
        ...
        if(subDer.isNumber()) {
            try {
                ...
                if(result.equals(one)) {
                    return new Mul(new Sec(this.subNodes[0].copy()), new Tan(this.subNodes[0].copy()));
                }
            }
        ...
        return new Mul(subDer, new Mul(new Sec(this.subNodes[0].copy()), new Tan(this.subNodes[0].copy())));
    }
    ...
    @Override
    public Node copy() {
        return new Sec(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sec(");
