 ...
 * 'true' if the two subnodes are not equal, otherwise it returns 'false'.
 * 
 * @author Peter Werno
 */
public class NotEquals extends Node {
    /**
     * Creates a new instance of NotEquals
     */
    public NotEquals() {
        super(2);
    }
    ...
    /**
     * Creates a new instance of NotEquals with both subnodes given
     * 
     * @param left (Node) the left node
     * @param right (Node) the right node
     */
    public NotEquals(Node left, Node right) {
        super(2);
    ...
    @Override
    public Node copy() {
        return new NotEquals(this.subNodes[0].copy(), this.subNodes[1].copy());
    }
