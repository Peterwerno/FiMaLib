...
/**
 * This class implements the trigonometrical function cosh
...
public class Cosh extends Node {
    ...
    /**
     * Creates a new instance of Cosh with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Cosh(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).cosh();
    }
    ...
    @Override
    public Node copy() {
        return new Cosh(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("cosh(");
