...
/**
 * This class implements the trigonometrical function arcsex
 * (arc secant)
 * 
 * @author Peter Werno
 */
public class Arcsec extends Node {
    /**
     * Creates a new instance of Arcsec
     */
    public Arcsec() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arcsec with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arcsec(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arcsec();
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arcsec(");
