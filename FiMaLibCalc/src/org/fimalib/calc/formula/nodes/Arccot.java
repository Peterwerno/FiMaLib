...
/**
 * This class implements the trigonometrical function arccot
 * (arc cotangent)
 * 
 * @author Peter Werno
 */
public class Arccot extends Node {
    /**
     * Creates a new instance of Arccot
     */
    public Arccot() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccot with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccot(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccot();
    }
    ...
    @Override
    public Node copy() {
        return new Arccot(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccot(");
