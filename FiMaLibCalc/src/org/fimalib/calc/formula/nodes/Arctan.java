...
/**
 * This class implements the trigonometrical function arctan
 * (arc tangent)
 * 
 * @author Peter Werno
 */
public class Arctan extends Node {
    /**
     * Creates a new instance of Arctan
     */
    public Arctan() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arctan with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arctan(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arctan();
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arctan(");
