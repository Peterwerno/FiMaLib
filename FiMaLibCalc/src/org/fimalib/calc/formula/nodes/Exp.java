...
/**
 * This class implements the value e ^ number
 * 
 * @author Peter Werno
 */
public class Exp extends Node {
    ...
    /**
     * Creates a new instance of Exp with a given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Exp(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).exp();
    }
    ...
    @Override
    public Node copy() {
        return new Exp(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("exp(");
