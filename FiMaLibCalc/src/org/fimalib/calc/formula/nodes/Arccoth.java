...
/**
 * This class implements the trigonometrical function arccoth
 * (arc cotangent hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arccoth extends Node {
    /**
     * Creates a new instance of Arccoth
     */
    public Arccoth() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccoth with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccoth(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccoth();
    }
    ...
    @Override
    public Node copy() {
        return new Arccoth(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccoth(");
