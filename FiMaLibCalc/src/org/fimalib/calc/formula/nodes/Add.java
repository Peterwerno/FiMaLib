...
public class Add extends Node {
    ...
    public Node derive(String parameterName) throws FormulaException {
        return new Add(this.subNodes[0].derive(parameterName), this.subNodes[1].derive(parameterName));
    }
    ...
    public Node integrate(String parameterName) throws FormulaException {
        return new Add(this.subNodes[0].integrate(parameterName), this.subNodes[1].integrate(parameterName));
    }
    ...
    @Override
    public Node copy() {
        return new Add(this.subNodes[0].copy(), this.subNodes[1].copy());
    }
