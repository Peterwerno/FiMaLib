...
/**
 * This class implements the trigonometrical function sin
 * (sinus)
 * 
 * @author Peter Werno
 */
public class Sin extends Node {
    ...
    /**
     * Creates a new instance of Sin with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Sin(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sin();
    }
    ...
    public Node derive(String parameterName) throws FormulaException {
        ...
        return new Mul(subDer, new Cos(this.subNodes[0].copy()));
    }
    ...
    @Override
    public Node copy() {
        return new Sin(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sin(");
