 ...
 * 'true' if the first subnode is greater than the second subnode, 
 * otherwise it returns 'false'.
 * 
 * For complex numbers, GreaterThan compares the ABSOLUTE value of the numbers,
 * while for Double numbers, the normal greater than (including negative 
 * numbers) is applied
 * 
 * @author Peter Werno
 */
public class GreaterThan extends Node {
    /**
     * Creates a new instance of GreaterThan
     */
    public GreaterThan() {
        super(2);
    }
    ...
    /**
     * Creates a new instance of GreaterThan with both subnodes given
     * 
    ...
    @Override
    public Node copy() {
        return new GreaterThan(this.subNodes[0].copy(), this.subNodes[1].copy());
    }
