...
/**
 * This class implements the trigonometrical function sech
 * (secant hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Sech extends Node {
    /**
     * Creates a new instance of Sech
     */
    public Sech() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Sech with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Sech(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sech();
    }
    ...
    @Override
    public Node copy() {
        return new Sech(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sech(");
