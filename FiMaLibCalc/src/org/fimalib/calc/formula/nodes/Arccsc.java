...
/**
 * This class implements the trigonometrical function arccsc
 * (arc cosecant)
 * 
 * @author Peter Werno
 */
public class Arccsc extends Node {
    /**
     * Creates a new instance of Arccsc
     */
    public Arccsc() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccsc with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccsc(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccsc();
    }
    ...
    @Override
    public Node copy() {
        return new Arccsc(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccsc(");
