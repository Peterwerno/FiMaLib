...
/**
 * This class implements the absolute function of a number
 * 
 * @author Peter Werno
 */
public class Abs extends Node {
    ...
    /**
     * Creates a new instance of Abs with a given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Abs(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).abs();
    }
    ...
    @Override
    public Node copy() {
        return new Abs(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("abs(");
