...
/**
 * This class implements the trigonometrical function cot
 * (cotangent)
 * 
 * @author Peter Werno
 */
public class Cot extends Node {
    /**
     * Creates a new instance of Cot
     */
    public Cot() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Cot with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Cot(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).cot();
    }
    ...
    public Node derive(String parameterName) throws FormulaException {
        ...
        Double two = new org.fimalib.calc.Double(2.0);
        ...
        if(subDer.isNumber()) {
            try {
                ...
                if(result.equals(one)) {
                    return new Neg(new Pow(new Csc(this.subNodes[0].copy()), new Constant(two)));
                }
            }
        ...
        return new Mul(subDer, new Neg(new Pow(new Csc(this.subNodes[0].copy()), new Constant(two))));
    }
    ...
    @Override
    public Node copy() {
        return new Cot(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("cot(");
