...
/**
 * This class implements the trigonometrical function tanh
...
public class Tanh extends Node {
    ...
    /**
     * Creates a new instance of Sinh with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Tanh(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).tanh();
    }
    ...
    @Override
    public Node copy() {
        return new Tanh(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("tanh(");
