...
/**
 * This class implements the trigonometrical function csch
 * (cosecant hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Csch extends Node {
    /**
     * Creates a new instance of Csch
     */
    public Csch() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Csch with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Csch(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).csch();
    }
    ...
    @Override
    public Node copy() {
        return new Coth(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("csch(");
