...
/**
 * This class implements the trigonometrical function sinh
 * (sinus hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Sinh extends Node {
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sinh();
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sinh(");
