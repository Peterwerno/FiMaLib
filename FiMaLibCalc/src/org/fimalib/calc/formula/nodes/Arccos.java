...
/**
 * This class implements the trigonometrical function arccos
 * (arc cosinus)
 * 
 * @author Peter Werno
 */
public class Arccos extends Node {
    /**
     * Creates a new instance of Arccos
     */
    public Arccos() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccos with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccos(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccos();
    }
    ...
    @Override
    public Node copy() {
        return new Arccos(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccos(");
