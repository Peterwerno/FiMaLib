...
/**
 * This class implements the trigonometrical function arccosh
 * (arc cosinus hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arccosh extends Node {
    /**
     * Creates a new instance of Arccosh
     */
    public Arccosh() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arccosh with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arccosh(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arccosh();
    }
    ...
    @Override
    public Node copy() {
        return new Arccosh(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arccosh(");
