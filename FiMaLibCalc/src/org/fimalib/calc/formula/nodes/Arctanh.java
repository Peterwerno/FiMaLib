...
/**
 * This class implements the trigonometrical function arctanh
 * (arc tangent hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arctanh extends Node {
    /**
     * Creates a new instance of Arctanh
     */
    public Arctanh() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arctanh with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arctanh(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arctanh();
    }
    ...
    @Override
    public Node copy() {
        return new Arctan(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arctanh(");
