...
public class Sqrt extends Node {
    ...
    /**
     * Creates a new instance of Sqrt with a given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Sqrt(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).sqrt();
    }
    ...
    @Override
    public Node copy() {
        return new Sqrt(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("sqrt(");
