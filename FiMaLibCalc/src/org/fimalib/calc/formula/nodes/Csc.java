...
/**
 * This class implements the trigonometrical function csc
 * (cosecant)
 * 
 * @author Peter Werno
 */
public class Csc extends Node {
    /**
     * Creates a new instance of Csc
     */
    public Csc() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Csc with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Csc(Node subNode) {
        super(1);
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("csc(");
