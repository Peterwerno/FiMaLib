...
/**
 * This class implements the trigonometrical function arcsinh
 * (arc sinus hyperbolicus)
 * 
 * @author Peter Werno
 */
public class Arcsinh extends Node {
    /**
     * Creates a new instance of Arcsinh
     */
    public Arcsinh() {
        super(1);
    }
    ...
    /**
     * Creates a new instance of Arcsinh with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Arcsinh(Node subNode) {
        super(1);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        return this.subNodes[0].calculate(parameters).arcsinh();
    }
    ...
    @Override
    public Node copy() {
        return new Arcsinh(this.subNodes[0].copy());
    }
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("arcsinh(");
