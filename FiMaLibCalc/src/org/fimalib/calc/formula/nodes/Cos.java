...
/**
 * This class implements the trigonometrical function cos
 * (cosinus)
 * 
 * @author Peter Werno
 */
public class Cos extends Node {
    ...
    /**
     * Creates a new instance of Cos with given subnode
     * 
     * @param subNode (Node) the subnode
     */
    public Cos(Node subNode) {
        super(1);
    ...
    public String toString() {
        StringBuilder retVal = new StringBuilder("cos(");
