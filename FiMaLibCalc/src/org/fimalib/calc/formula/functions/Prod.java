...
/**
 * This class implements a product function.
 ...
 * multiplied up.
 * 
 * TODO: Make sure that an "underflow" does not result in an endless loop
 * 
 * @author Peter Werno
 */
public class Prod extends Function {
    ...
    /**
     * Creates a new instance of Prod with all parameters given
     * 
     ...
     */
    public Prod(Node parameter, Node startValue, Node endValue, Node formula) throws FormulaException {
        super(4);
        ...
        if(parameter instanceof Variable) {
            ...
            throw new FormulaException("First parameter of prod function must be a variable name!");
     ...
     * @param formula (Node) the formula that is to be summed up
     */
    public Prod(String parameter, Node startValue, Node endValue, Node formula) {
        super(4);
    ...
    public Number calculate(HashMap<String, Number> parameters) throws FiMaLibCalcException {
        ...
        Number retVal = new Double(1.0, value.getNumberFormat());
        ...
        while(value.compareTo(endVal) <= 0) {
            ...
            retVal = retVal.mul(this.formula.calculate(parameters));
    ...
    /**
     * Returns the derivative of the prod function
     * 
